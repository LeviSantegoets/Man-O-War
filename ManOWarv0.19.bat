...
echo "joindc"     - join a domain
echo "leavedc"    - leave a domain
echo "addsgetusr" - list all domain users and inspect one
echo "addsgetgrp" - list all domain groups and inspect one
echo "listorgunit"- list all organisational units of AD/DS
echo "addusrtoou" - add user to an organisational unit in AD/DS
echo "expusrfrmou"- expel a user from an organisational unit in AD/DS
echo "addgrptoou" - add a group to an orgranisational unit in AD/DS
echo "expgrpfrmou"- expel a group from an organisational unit in AD/DS
