...
if "!BLOCKED!"=="true" (
    echo Blacklisted. Access denied.
    pause
    exit /b 1
)
...
REM 3. DEFAULT DENY
REM --------------------------
echo Not whitelisted. Access denied.
pause
exit /b 1
:publicipallowed
REM [blacklistsecurity]
REM PRESENT FUNCTION VARIABLE:
SET functioncounts=149
...
echo.                                                                                 %vrsion%
echo Navigate your systems like a battleship.
echo.
:ebrx
:catspallin
