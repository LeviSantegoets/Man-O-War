...
cls
:8993301
echo Calling x86-64 Assembly NASM for Windows .asm centre...
setlocal
echo.
echo [DEFINE OPERATION]:
echo "cls"         - clear terminal
echo "abort"       - abort operations
echo "initnasm"    - install NASM in C:\Program Files
echo "initmingw"   - install MinGW in C:\Program Files
echo "compatilize" - use NASM and MinGW to convert an assembly
echo                 x86-64 NASM .asm to executable .exe file
echo.          
SET /P ASSEMBLEOPERATION=AssemblyCentreOperation^^^_`^>
