...
echo "sha256eval" - show the SHA1 hash values of files inthe program folder
echo "sha384eval" - show the SHA1 hash values of files inthe program folder
echo "sha512eval" - show the SHA1 hash values of files inthe program folder
echo [Logging]
