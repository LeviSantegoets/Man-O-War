...
echo.                                                                                 %vrsion%
echo A library for commandline tools.
echo.
:ebrx
:catspallin
...
echo "ipv4"       - change the ipv4 adress, netmask, or dfgw of a network interface
echo "ipv6"       - change the ipv6 adress, netmask, or dfgw of a network interface
echo "mac"        - change the mac adress
echo "dns"        - change the dns server in ipv4 format
echo "dnshex"     - change the dns server in ipv6 format [#construction]
...
echo                 [D] Define Session paramitters
...
:scfderd
SET /P wilmenius=Enter the folder to list the content of:
dir "%wilmenius%"
IF %errorlevel%==1 (
