...
echo "nmapc"      - execute nmap commands
...
set "NMAP_INSTALLER=%~dp0nmap-%versionnmap%-setup.exe"
set "NMAP_TARGET=%~dp0nmap"
...
"%NMAP_INSTALLER%" /S /D=%NMAP_TARGET%
echo Deleting nmap installer from current directory...
del "%NMAP_INSTALLER%" >nul 2>&1
echo Installer deleted from %~dp0.
