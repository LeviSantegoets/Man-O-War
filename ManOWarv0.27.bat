...
echo.
echo "An inventor is one who can see the applicability of means
echo  to supply demand five years before it is obvious to those
echo  skilled in the art". ~ Reginald Fessenden.
:ebrx                            
:catspallin
...
goto catspallin
REM help menu is sliced up in divisions.
:help
:intervalMOW
...
:intervalAS
echo [Assembly]
echo "8664"       - x86-64 Assembly NASM for Windows .asm centre
...
goto catspallin
REM reconstruct helpmenu segmentated divisions
:inputclsacadfldtrst
cls
:explorerr
...
echo "as"    -    x8664 assembly commands
...
echo "td"    -    threath detection commands
